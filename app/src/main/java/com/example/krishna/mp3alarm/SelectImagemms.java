...
import com.example.krishna.mp3alarm.adaptersmms.ImageAdapter;
...
public class SelectImagemms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.krishna.mp3alarm.R.layout.activity_select_imagemms);

        RecyclerView recyclerView = findViewById(com.example.krishna.mp3alarm.R.id.image_recycler_view);
