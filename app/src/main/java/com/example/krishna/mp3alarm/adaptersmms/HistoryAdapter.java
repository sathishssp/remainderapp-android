...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.example.krishna.mp3alarm.R.layout.alarm_history_viewmms, parent, false);
...
//        holder.historyTimeTextView.setText(historyList.get(position).getFormattedTime());
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            super(view);
            historyImageView = view.findViewById(com.example.krishna.mp3alarm.R.id.schedule_image_view);
            historyMessageTextView = view.findViewById(com.example.krishna.mp3alarm.R.id.schedule_message_text_view);
            historySetterNameTextView = view.findViewById(com.example.krishna.mp3alarm.R.id.schedule_setter_name_text_view);
            historyDateTextView = view.findViewById(com.example.krishna.mp3alarm.R.id.schedule_date_text_view);
            historyTimeTextView = view.findViewById(com.example.krishna.mp3alarm.R.id.schedule_time_text_view);
            receiverTextView = view.findViewById(com.example.krishna.mp3alarm.R.id.receiver_text_view);
            historyRootLayout = view.findViewById(com.example.krishna.mp3alarm.R.id.history_root_layout);
        }
    }
}
