 ...
 */
public class RecordingSer extends Service {

    private static final String LOG_TAG = "RecordingSer";
    ...
    public void onCreate() {
        super.onCreate();
        mDatabase = new DBHelp(getApplicationContext());
    ...
    public void startRecording() {
        ...
        if (MySharedPref.getPrefHighQuality(this)) {
