...
import com.trident.krishna.mp3alarm.sharedPreferenceManagermms.SharedPrefManager;
...
public class AllowedNumbersmms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.trident.krishna.mp3alarm.R.layout.activity_allowed_numbersmms);
    ...
    private void initializeVariables() {
        saveButton = findViewById(com.trident.krishna.mp3alarm.R.id.save_button);
        phoneNumberEditText = findViewById(com.trident.krishna.mp3alarm.R.id.phone_number_edit_text);
        allowedNumbersListView = findViewById(com.trident.krishna.mp3alarm.R.id.allowed_numbers_list_view);
        pickContact = findViewById(com.trident.krishna.mp3alarm.R.id.pick_contact);
        instructionLinearLayout = findViewById(com.trident.krishna.mp3alarm.R.id.instruction_linear_layout);
    }
