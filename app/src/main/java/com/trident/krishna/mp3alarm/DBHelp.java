...
import com.trident.krishna.mp3alarm.listen.OnDatabaseChangedListener;

import java.util.Comparator;

import static com.trident.krishna.mp3alarm.DBHelp.DBHelperItem.TABLE_NAME;
...
public class DBHelp extends SQLiteOpenHelper {
    ...
    private static final String LOG_TAG = "DBHelp";
    ...
    public RecordingIt getItemAt(int position) {
        ...
        if (c.moveToPosition(position)) {
            RecordingIt item = new RecordingIt();
    ...
    public class RecordingComparator implements Comparator<RecordingIt> {
        public int compare(RecordingIt item1, RecordingIt item2) {
    ...
    public void renameItem(RecordingIt item, String recordingName, String filePath) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_NAME, recordingName);
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH, filePath);
    ...
    public long restoreRecording(RecordingIt item) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
