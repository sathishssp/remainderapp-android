...
import com.trident.krishna.mp3alarm.adaptersmms.HistoryAdapter;
...
import com.trident.krishna.mp3alarm.databasemms.model.MyAlarmsDBModel;
...
public class MySchedulesmms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.trident.krishna.mp3alarm.R.layout.activity_alarm_historymms);

        historyRecyclerView = findViewById(com.trident.krishna.mp3alarm.R.id.alarms_recycler_view);
