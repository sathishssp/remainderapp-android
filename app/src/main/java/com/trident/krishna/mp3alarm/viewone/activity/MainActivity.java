package com.trident.krishna.mp3alarm.viewone.activity;
...
import com.trident.krishna.mp3alarm.controllerone.AlarmsManager;
import com.trident.krishna.mp3alarm.viewone.AlarmsListArrayAdapter;
import com.trident.krishna.mp3alarm.viewone.fragment.AddAlarmFragment;
import com.trident.krishna.mp3alarm.viewone.fragment.AlarmsListFragment;
import com.trident.krishna.mp3alarm.viewone.fragment.EditAlarmFragment;
...
public class MainActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_mainone);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.main_activity_actionsone, menu);
	...
	public void onBackPressed(){
		super.onBackPressed();
		Intent intent = new Intent(com.trident.krishna.mp3alarm.viewone.activity.MainActivity.this, alarmpage.class);
	...
	public void refreshListAdapter() {
		if (alarmAdapter == null) {
			alarmAdapter = new AlarmsListArrayAdapter(this,
					R.layout.alarm_listview_rowone, alarmsManager.getAllAlarms(),
					this);
		}
		alarmAdapter.clear();
