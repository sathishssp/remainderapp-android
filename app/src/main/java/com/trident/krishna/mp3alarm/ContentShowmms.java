...
import com.trident.krishna.mp3alarm.databasemms.DatabaseHelper;
import com.trident.krishna.mp3alarm.databasemms.model.AlarmHistoryDBModel;
import com.trident.krishna.mp3alarm.resourceManagermms.ResourceManager;

public class ContentShowmms extends AppCompatActivity {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.trident.krishna.mp3alarm.R.layout.activity_content_showmms);
        ...
        imageView = findViewById(com.trident.krishna.mp3alarm.R.id.content_image_view);
        messageTextView = findViewById(com.trident.krishna.mp3alarm.R.id.message_text_view);
        receiverTextView = findViewById(com.trident.krishna.mp3alarm.R.id.receiver_text_view);
        Bundle bundle = getIntent().getExtras();

        if (bundle == null)
            return;

        int id = bundle.getInt(Constantsmms.ID);
        String tableName = bundle.getString(Constantsmms.TABLE_NAME);
        String receiverText = bundle.getString(Constantsmms.RECEIVER);
        boolean isPreview = bundle.getBoolean(Constantsmms.PREVIEW);
    ...
    private void setSenderPhoneAndNameText(String number, String name) {
        String nameAndPhone;
        TextView nameAndPhoneTextView = findViewById(com.trident.krishna.mp3alarm.R.id.sender_name_text_view);
